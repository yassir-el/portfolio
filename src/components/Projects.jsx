  ...
  return (
    <div id='projects' className='pt-28'>
      ...
      </h2>
      {
        ...
        >
          <motion.div className='max-w-[800px] p-4 mx-8 bg-[#171721]  rounded-xl flex flex-col gap-4 overflow-hidden 
           scale-105
          shadow-[0_0_16px_black]
            ...
            <div className='flex justify-between px-4'>
              <div className='flex gap-2'>
                <a href={projectsData[show - 1].codeLink} target='_blank' className='py-3 px-6 rounded-lg border-[#854ce680] border-2 text-lg bg-[#854ce680] text-white'>
                  <FaGithub />
                </a>
                <a href={projectsData[show - 1].demoLink} target='_blank' className='py-3 px-6 rounded-lg border-[#854ce680] border-2 text-lg bg-[#854ce680] text-white'>
                  <FaLink />
                </a>
              </div>
